...
#include "bt_discrete_dynamics_world.h"
...
#include "bullet_collision/collision_dispatch/bt_simulation_island_manager.h"
...
#include "bullet_dynamics/constraint_solver/bt_contact_constraint.h"
...
#include "bullet_dynamics/dynamics/bt_action_interface.h"
#include "linear_math/bt_quickprof.h"
...
int	btDiscreteDynamicsWorld::stepSimulation( btScalar timeStep,int maxSubSteps, btScalar fixedTimeStep)
{
	...
	} else
	{
		...
		m_fixedTimeStep = 0;
		if (btFuzzyZero(timeStep))  // timeStep < FLT_EPSILON
		{
