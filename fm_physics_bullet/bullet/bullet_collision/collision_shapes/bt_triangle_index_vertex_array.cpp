...
#include "bt_triangle_index_vertex_array.h"
...
btTriangleIndexVertexArray::btTriangleIndexVertexArray(int numTriangles,short* triangleIndexBase,int triangleIndexStride,int numVertices,btScalar* vertexBase,int vertexStride)
: m_hasAabb(0)
{
    btIndexedMesh mesh;
