...
#include "bt_simplex_solver_interface.h"

// 实现了1到4个顶点的单纯形到原点的距离计算
...
public:
    ...
    /*
        m_simplexVectorW中存放的是单纯形的顶点， m_simplexVectorP, m_simplexVectorQ中存放的是
        两个物体中和单纯形顶点m_simplexVectorW相对应的顶点，注意，这儿单纯形表示是明可夫斯
        基差形状中的单纯形，所以m_simplexVectorP, m_simplexVectorQ就是表示两个物体中的顶点，
        并且m_simplexVectorP - m_simplexVectorQ = m_simplexVectorW。 （都是世界坐标系中的值）
    */
