	...
	int iCmdShow)
{
	...
	if (true)
	{
		...
		wndclass.lpszClassName = TEXT("fm_demo");
		...
		hwnd = CreateWindow(TEXT("fm_demo"), TEXT("fm_demo"), WS_VISIBLE|WS_CAPTION|WS_SYSMENU|WS_OVERLAPPEDWINDOW,
