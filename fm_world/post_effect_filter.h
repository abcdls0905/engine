...
#ifndef _POST_EFFECT_PPFILTER_H_
#define _POST_EFFECT_PPFILTER_H_
...
class TPostEffectFilterShaderAlloc
{
public:
	TPostEffectFilterShaderAlloc() {}
	~TPostEffectFilterShaderAlloc() {}
	...
	// 交换
	void Swap(TPostEffectFilterShaderAlloc& src) {}
};



class CPostEffectFilter: public CPostEffect
{
	struct post_effect_filter_cb_t
	{
		bool   bGradualEnable;
		bool   bAdjustEnable;
		bool   bAngleEnable;
	...
	struct post_effect_filter_shaderhandle_t
	{
...
private:
	static void RenderPostFilterEffect(void* pdata);
	CPostEffectFilter::post_effect_filter_shaderhandle_t* GetShaderHandle();

	void SetShaderConstValue(CPostEffectFilter::post_effect_filter_shaderhandle_t* pShaderHandle);
protected:
	bool m_bVisible;
	...
	TPodHashMap<unsigned int, CPostEffectFilter::post_effect_filter_shaderhandle_t*, TPodTraits<unsigned int>, TPostEffectFilterShaderAlloc> m_ShaderMapHandle;

	post_effect_filter_cb_t m_filter_cb;
};
