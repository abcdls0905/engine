...
#fm_input
include $(CLEAR_VARS)
MY_LOCAL_PATH := $(LOCAL_CODE_PATH)fm_input/
LOCAL_MODULE    := libfm_input
LOCAL_SRC_FILES := \
$(MY_LOCAL_PATH)input_device_caps.cpp\
$(MY_LOCAL_PATH)input_event.cpp\
$(MY_LOCAL_PATH)input_keyboard.cpp\
$(MY_LOCAL_PATH)input_manager.cpp\
$(MY_LOCAL_PATH)input_mouse.cpp\
$(MY_LOCAL_PATH)input_touch.cpp\
...
include $(CLEAR_VARS)
MY_LOCAL_PATH := $(LOCAL_CODE_PATH)fm_demo/
LOCAL_MODULE    := libapp
LOCAL_SRC_FILES := \
$(MY_LOCAL_PATH)android_app.cpp\
$(MY_LOCAL_PATH)app.cpp\
$(MY_LOCAL_PATH)free_camera.cpp\
$(MY_LOCAL_PATH)game_main.cpp\
$(MY_LOCAL_PATH)game_scene.cpp\
$(MY_LOCAL_PATH)role_composite.cpp\
$(MY_LOCAL_PATH)helper.cpp\
$(MY_LOCAL_PATH)jnifile.cpp\
$(MY_LOCAL_PATH)lib_main.cpp\
