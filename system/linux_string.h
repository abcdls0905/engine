...
#ifndef _SYSTEM_LINUX_STRING_H
#define _SYSTEM_LINUX_STRING_H
...
#else
	char szTemp[128] = {0};
	Port_WideStrToString(str, szTemp, sizeof(szTemp));
	return Port_StringToInt64(szTemp);
#endif
}
...
#ifdef __ANDROID__
	int res = vsnwprintf_android(buf, size_1, info, args);
#else
