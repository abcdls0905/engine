...
#ifndef _SYSTEM_LINUX_ENCODING_H
#define _SYSTEM_LINUX_ENCODING_H
...
{
#ifdef __ANDROID__
	return Port_WideStrToUTF8(info, buf, byte_size);
#else
	setlocale(LC_ALL, "");
...
#endif // _SYSTEM_LINUX_ENCODING_H
