...
void main (void)
{
	...
	mediump vec3 light_dir = c_vLightDir;
		...
		diffuse_color.xyz *= c_MaterialDiffuse.xyz;
			...
			diffuse_color.xyz += point_light_inten * point_light_rang * c_MaterialDiffuse.xyz * c_PointLightDiffuse.xyz;
		#endif
	...
	#if defined SPECULAR || defined SPECULARMAP
        mediump float temp = 2.5;
		specular_color = specular_inten*temp * specular_material.xyz * c_LightDiffuse.xyz;
